library(ggplot2)
file.choose()
sods_data <- read.csv("/Users/thihoanguyen/Desktop/year 3/computing/MT/git-usage/data/stackoverflow-git-data.csv")

#set working directory
setwd("/Users/thihoanguyen/Desktop/year 3/computing/MT/git-usage")
...
ggsave(filename =  "/Users/thihoanguyen/Desktop/year 3/computing/MT/git-usage/out/git-usage.png",
       plot = g,
       height = 7.4,
       width = 10.5,
       units = "cm")
g #run this to view g
